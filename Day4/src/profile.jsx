          ...
          <header>
            <CustomNavbar/>
              ...
              <div className='profile__container'>
                <p className='profile__para'>UserName:</p> <p style={{fontSize:20}}>Deepika</p> <p style={{color:'blue'}}>edit</p>
                <br/> 
                <p className='profile__para'>Email: </p><p style={{fontSize:20}}>deepika@gmail.com</p> <p style={{color:'blue'}}>edit</p>
                 <br/>
