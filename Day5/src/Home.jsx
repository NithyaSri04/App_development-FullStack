...
const Home = () => {
   ...
   <h1 style={{textAlign:"center",marginLeft:"0px", color:"black"}}>Welcome User!</h1>
   <img src={chess_img} style={{height:"500px", width:"800px",textAlign: "center",objectFit:"cover"}}/>
  </div>
  <br/>
